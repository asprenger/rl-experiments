...
def train(env_id, num_envs, num_timesteps, seed, cuda_visible_devices, gpu_memory_fraction, output_dir):

    env = make_atari_env(env_id, num_envs, seed, output_dir='', record_video=False)
